...
def write_slurm(field_name):
    with open("/project/apdw/Software/aper_sf2/slurm_out/slurm_"+field_name+"_"+date_string+".sh", "w") as f:
        ...
        f.write('snakemake --cores 8 -s Tnakefile_slurm --rerun-incomplete --use-singularity --singularity-args "--bind /project/apdw/" --resources mem_mb=64000 --config FIELD='+field_name)
